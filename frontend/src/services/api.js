...
class ApiService {
  ...
  // Patient History API methods
  async getPatientHistory(patientId) {
    return this.get(`/patients/${patientId}/history`);
  }

  async addPatientVisit(patientId, visitData) {
    return this.post(`/patients/${patientId}/visits`, visitData);
  }

  async updatePatientVisit(patientId, visitId, visitData) {
