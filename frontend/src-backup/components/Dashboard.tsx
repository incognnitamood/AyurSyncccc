    ...
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden animate-slide-scale rounded-3xl border-2 border-[#61803F]/20 shadow-2xl perspective-card">
        <div className="w-full">
          ...
          /> */}
          <div className="w-full h-64 bg-gradient-to-br from-[#84A15D]/20 to-[#61803F]/20 flex items-center justify-center rounded-2xl border-2 border-[#61803F]/20">
            <div className="text-center p-8">
              <h2 className="text-3xl font-bold text-[#61803F] mb-4" style={{ fontFamily: 'Georgia, serif' }}>Welcome to AyurSync</h2>
              <p className="text-lg text-[#677D5E]" style={{ fontFamily: 'Georgia, serif' }}>Bridging ancient Ayurvedic wisdom with cutting-edge nutrition science</p>
            </div>
          </div>
        </div>
